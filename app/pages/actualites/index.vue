    ...
    <section class="section news-hero">
      <div class="container split-section reverse">
        <div class="split-copy">
          ...
          <h1 class="display-title">Suivre les actions, les projets et les ressources publiées par IFICS.</h1>
        ...
        <div class="split-media"><img :src="publicVisuals.news" alt="Publications et actualités suivies par IFICS"></div>
      </div>
    </section>
...
.publication-list { background: #f3f6f4; border-block: 1px solid #e5ece7; }
.publication-card { min-height: 100%; }
.publication-card h2 { margin: 14px 0 8px; font-size: 1.1rem; line-height: 1.28; }
