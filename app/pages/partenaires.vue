    ...
    <section class="section partner-hero">
      <div class="container split-section reverse">
        <div class="split-copy">
          ...
          <h1 class="display-title">Construire ensemble des actions qui répondent à un besoin réel.</h1>
        ...
        <div class="split-media"><img :src="publicVisuals.insertion" alt="Échange entre une professionnelle et un jeune autour de son parcours"></div>
      </div>
    </section>
...
.partner-modes { background: #eff4f0; border-block: 1px solid #e5ece7; }
.partner-modes h2 { margin: 9px 0; font-size: 1.14rem; }
...
.partner-logo { width: 82px; height: 58px; display: grid; place-items: center; margin-bottom: 16px; border-radius: 12px; background: #f5f8f6; border: 1px solid var(--ifics-border); color: var(--ifics-green-800); font-size: 1.4rem; font-weight: 850; }
